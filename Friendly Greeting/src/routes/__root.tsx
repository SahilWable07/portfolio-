...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sahil Wable | AI Engineer | Generative AI & LLM Systems" },
      {
        name: "description",
        content:
          "Portfolio of Sahil Wable, an AI Engineer building Generative AI applications, LLM systems, AI agents, RAG pipelines, and real-time voice AI systems.",
      },
      { name: "author", content: "Sahil Wable" },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var t=localStorage.getItem('sw-theme');if(t==='light'){document.documentElement.classList.remove('dark')}}catch(e){}",
          }}
        />
      </head>
